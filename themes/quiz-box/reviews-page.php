    ...
    <div class=" wrapper wrapper-games">
                ...
                <ul class="reviews__list">
                    <li class="reviews__item">
                        <div class="reviews__header">
                            <img src="<? echo get_template_directory_uri() ?>/assets/quiz-box//img/avatars/ginger.jpeg" alt="avatar" class="reviews__avatar">
                            <div class="user-desc">
                                <div class="user-desc__name">Иван Петрович
                                    <a href="#" class="user-desc__socials">
                                        <img class='user-desc__ico' src="<? echo get_template_directory_uri() ?>/assets/quiz-box//img/svg/vk.png" alt="">
                                    </a>
                                </div>
                    ...
                    <li class="reviews__item">
                        <div class="reviews__header">
                            <img src="<? echo get_template_directory_uri() ?>/assets/quiz-box//img/avatars/liza.jpeg" alt="avatar" class="reviews__avatar">
                    ...
                    <li class="reviews__item">
                        <div class="reviews__header">
                            <img src="<? echo get_template_directory_uri() ?>/assets/quiz-box//img/avatars/girl.jpeg" alt="avatar" class="reviews__avatar">
                    ...
                    <li class="reviews__item">
                        <div class="reviews__header">
                            <img src="<? echo get_template_directory_uri() ?>/assets/quiz-box/img/avatars/gay.jpeg" alt="avatar" class="reviews__avatar">
        ...
        <section class="separator">
            <div class=" container separator__container">
                ...
                <img class='separator__img' src="<? echo get_template_directory_uri() ?>/assets/quiz-box/img/separator.png" alt="">
            </div>
        </section>
