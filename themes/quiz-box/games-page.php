                ...
                <ul class="games__list">
                    <li class="games__item">
                        <div class="games__header">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/music-quiz1.png" alt="" class="games__img ">
                        </div>
                    ...
                    <li class="games__item">
                        <div class="games__header">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/bacto90.png" alt="" class="games__img">
                        </div>
                        <div class="games__content">
                ...
                <ul class="partners__list">
                    <li class="partners__item">
                        ...
                        <a href="" class="partners__link">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/pobeda.png" alt="pobeda" class="partners__logo">
                        </a>
                    </li>
                    <li class="partners__item">
                        <a href="" class="partners__link">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/s7-airlines.png" alt="s7-airlines" class="partners__logo">
                        </a>
                    </li>
                    <li class="partners__item">
                        <a href="" class="partners__link">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/quiz-please.svg" alt="quiz-please" class="partners__logo">
                        </a>
                    </li>
                    <li class="partners__item">
                        <a href="" class="partners__link">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/liga-quiz.svg" alt="liga-quiz" class="partners__logo">
                        </a>
                    </li>
                    <li class="partners__item">
                        <a href="" class="partners__link">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/quest-room.png" alt="quest-room" class="partners__logo">
                        </a>
                    </li>
                    <li class="partners__item">
                        <a href="" class="partners__link partners__link--pegasus ">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/pegasus.png" class="partners__logo">
                        </a>
                    </li>
                    <li class="partners__item">
                        <a href="" class="partners__link">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/airbaltic.png" alt="airbaltic" class="partners__logo">
                        </a>
                    </li>
                    <li class="partners__item">
                        <a href="" class="partners__link">
                            <img src="<? echo get_template_directory_uri()?>/assets/quiz-box/img/partners-logos/pegas.png" alt="pegas" class="partners__logo">
                        </a>
                    </li>
                </ul>
